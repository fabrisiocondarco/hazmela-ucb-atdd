...
// Historia de Usuario:
//
// Como usuario quiero usar filtros para las tags de las publicaciones
//
// Prueba de Aceptación:
//
// Verificar que si un tag no tiene publicaciones asociadas, no se muestran publicaciones al seleccionarlo en el panel de filtros avanzados
//
...
// Resultado Esperado:
//
// No se muestran publicaciónes con el tag seleccionado
/****************************************/

public class TagVacioTest extends BaseTest {
    ...
    public void verificarTags() {
        ...
        // Se selecciona el tag con el texto "Quimica" para filtrar el feed por ese tag

        WebElement tag=
                driver.findElement(
                        By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div[2]/div[4]")
                );
        ...
        /********** Verificación **********/
        // PASO 5: Se verificará que no se muestren publicaciones con el tag seleccionado

        WebElement verificarPublicacion =
                driver.findElement(
                        By.xpath("//*[@id=\"root\"]/div[2]/div/div[3]/h3")
                );
        boolean TagVacio = verificarPublicacion.getText().contains("No se encontraron anuncios");
        Assert.assertEquals(true, TagVacio);


        // Se imprime en consola la confirmación de que se aplicó el filtro correcto

        System.out.println(
                "El tag seleccionado no tiene publicaciones asociadas: "
                        + TagVacio
        );
    }
}